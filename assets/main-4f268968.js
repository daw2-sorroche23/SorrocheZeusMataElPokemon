  ...
  script: (perfilLogueado) => {
    ...
    if (rol !== "anonimo") {
      ...
      document.querySelector(".liLogout").addEventListener("click", async (e) => {
        ...
        await User.logout();
        header.script();
        window.location.href = "/SorrocheZeusMataElPokemon/#/home";
      });
    } else {
...
const enrutador = {
  ...
  rutas: {
    home: __vitePreload(() => import("./home-62a0bd1b.js"), true ? ["./home-62a0bd1b.js","./pokemon-ff9e37cb.js","./partidas-62c8ee6a.js"] : void 0, import.meta.url),
    // Usuarios
    // adminUsuarios: import('../vistas/admin/adminVista.js'),
    registro: __vitePreload(() => import("./registroVista-5f158370.js"), true ? [] : void 0, import.meta.url),
    login: __vitePreload(() => import("./loginVista-02e34b17.js"), true ? [] : void 0, import.meta.url),
    perfiles: __vitePreload(() => import("./perfil-bcbfd880.js"), true ? [] : void 0, import.meta.url),
    pokemons: __vitePreload(() => import("./pokemons-571cb836.js"), true ? ["./pokemons-571cb836.js","./pokemon-ff9e37cb.js"] : void 0, import.meta.url),
    partidas: __vitePreload(() => import("./partidas-f7ae465d.js"), true ? ["./partidas-f7ae465d.js","./partidas-62c8ee6a.js"] : void 0, import.meta.url)
    // Proyectos
...
window.location = "/SorrocheZeusMataElPokemon/#/home";
export {
  Perfil as P,
  User as U,
  commonjsGlobal as c,
